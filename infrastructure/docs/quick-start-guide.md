...
Add it to [infrastructure/everything.py](https://github.com/tangentlabs/tangent-importer/blob/master/infrastructure/everything.py)
...
[annotated version]: https://github.com/tangentlabs/tangent-importer/blob/master/docs/annotated.md
