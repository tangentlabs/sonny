...
Add it to [infrastructure/everything.py](https://github.com/tangentlabs/sonny/blob/master/sonny/infrastructure/everything.py)
...
[annotated version]: https://github.com/tangentlabs/sonny/blob/master/sonny/docs/annotated.md
